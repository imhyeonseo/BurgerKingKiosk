...
```json
[
  { "id": 10, "name": "와퍼", "price": 7100, "imageUrl": "/images/menu/whopper.jpg", "isSet": false, "isSoldOut": false },
  { "id": 16, "name": "와퍼 세트", "price": 9900, "imageUrl": "/images/menu/whopper-set.jpg", "isSet": true, "isSoldOut": true }
]
```
...
```json
{
  ...
  "price": 7100,
  "imageUrl": "/images/menu/whopper.jpg",
  "isSet": false,
  "isSoldOut": false,
  "setComponents": null
}
...
```json
{
  ...
  "price": 9900,
  "imageUrl": "/images/menu/whopper-set.jpg",
  "isSet": true,
  "isSoldOut": false,
  "setComponents": [
...
```json
[
  { "id": 10, "name": "와퍼", "price": 7100, "imageUrl": "/images/menu/whopper.jpg", "isSet": false, "categoryName": "버거", "isSoldOut": false }
]
```
...
```json
{
  ...
  "sessionId": "b3c1e2b0-...",
  "items": [
    { "cartItemId": 21, "menuId": 10, "menuName": "와퍼", "price": 7100, "imageUrl": "/images/menu/whopper.jpg", "quantity": 2, "subtotal": 14200, "isSoldOut": false }
  ],
  "totalPrice": 14200
}
```
...
```json
{
  ...
  "imageUrl": "/images/menu/whopper-set.jpg", "isSet": true, "quantity": 50, "isActive": true,
...
요청 Body는 3.8.3과 동일하되 `isSet`은 서버에서 `true`로 고정한다. 이 시점에는 구성품이 없는 "빈 세트"가 생성된다.
